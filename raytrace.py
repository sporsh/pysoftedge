...
def main():
    ...
    scene.lights.append(Light(Point3(320.0, 240.0, .0), .8))

    scene.renderables.append(Sphere(Point3(140.0, 60.0, 600.0), 100.0, color.WHITE))
    scene.renderables.append(Sphere(Point3(320.0, 60.0, 600.0), 100.0, color.WHITE))
    scene.renderables.append(Sphere(Point3(500.0, 60.0, 600.0), 100.0, color.WHITE))

    scene.renderables.append(Sphere(Point3(140.0, 240.0, 600.0), 100.0, color.RED))
    scene.renderables.append(Sphere(Point3(320.0, 240.0, 600.0), 100.0, color.GREEN))
    scene.renderables.append(Sphere(Point3(500.0, 240.0, 600.0), 100.0, color.BLUE))

    c = color.Color(.1, .1, .1)
    scene.renderables.append(Sphere(Point3(140.0, 420.0, 600.0), 100.0, c))
    scene.renderables.append(Sphere(Point3(320.0, 420.0, 600.0), 100.0, c))
    scene.renderables.append(Sphere(Point3(500.0, 420.0, 600.0), 100.0, c))
